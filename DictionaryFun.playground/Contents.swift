 ...
 */
var states = ["New York": "Albany", "Ohio": "Columbus", "Florida": "Tallahassee", "Atlanta": "Georgia", "Kentucky": "Frankfort"]
 ...
 */
var anotherCap = states["Pennsylvania"]


if let anotherCap = anotherCap {
    print("Pennsylvania's capital is \(anotherCap).")
}
...
var capitalNY = states[state]

if let capitalNY = capitalNY {
    print("The capital of \(state) is \(capitalNY).")
}
 ...
 */
var band = ["Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
            "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
            "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macpherson"],
            "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"] ]
...
let bandName = "Pixies"
// write your code here
//var anotherBand = band[bandName]



if let anotherBand = band[bandName] {
    print(anotherBand)
}
